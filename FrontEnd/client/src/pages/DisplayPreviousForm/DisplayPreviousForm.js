...
const DisplayPreviousForm = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          ...
          // Create a custom set of headers
                ...
                const response = await fetch(`${globalUrl}/list/forms/previous`, {
                    method: 'GET',
    ...
    // console.log("++++++",previousFormData)
      ...
      const handleFormClick = (formId,formName) => {
        ...
        navigate(`/displayPreviousForm/${formName}/${formId}`);
...
export default DisplayPreviousForm